...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Generate GitHub issue creation commands from a review Markdown file."
    )
    ...
    while current_line_idx < len(lines):
        ...
        if match:
            ...
            block_end_idx = extract_next_finding_or_heading_index(
            ...
            if (
                not body.strip() and full_finding_text
